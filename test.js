...
async function test(){
    let repos = await get_repos_with_schema("zakarialaoui10",{includeForks:false})
    for(let repo in repos){
        ...
        repos[repo].contribution = await check_contribution("mouadizani","zakarialaoui10",repo);
    }
    return repos
} 
console.time()
